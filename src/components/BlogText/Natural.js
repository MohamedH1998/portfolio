...
const Natural = () => {
    return (
        <div>
            <h5 className="blog-subheadings"><i>'Do what comes naturally'</i></h5>
            <h5 className="blog-subheadings"><i>'It’s only natural'</i></h5>
            <h5 className="blog-subheadings"><i>'Let nature run its course'</i></h5> 
            <p className="blog-p">
                We all accept these phrases and those that are similar as being logically sound without question. If something comes naturally, then surely it must be right, and if it was going to happen anyway, then it must be good, right? Examples of these include our unreasonable acceptance that gut feelings are ignored at our own peril and a mother’s intuition is always right.
                <br></br>  
                <br></br>  
            ...
            <br></br>
            <h5 className="blog-subheadings">Nature/Natural in different traditions</h5>
            <p className="blog-p">
                ...
                <br></br>
                <br></br>
                Nature/natural plays an important role in Islam. Muslims believe that all humans are born with the fitrah (primordial nature) which can also be translated to natural disposition or tendency. Intrinsic to this is the ability to perceive the Oneness of God, and through adverse environmental influences and/or self-indulgence is this disposition influenced and contaminated.</p>
                <br></br>
            <h5 className="blog-subheadings">Problems with the term</h5>
            <p className="blog-p">
            ...
            <p className="blog-p">
                ...
                <br></br>
                Unfortunately, it’s easy for the unexamined past to resemble a utopia, but with the slightest bit of inspection, we can come to learn that that's the furthest from the truth one. Maternal mortality in the UK in the early 18th century was as high as 1000 per 100,000 births and is now at 19 per 100,000 births (as of 2016), which can be largely attributed to transcending nature and implementing the ‘unnatural’ practices which saw advances in healthcare.
                <br></br>
                In the process of medicalising pregnancy to ensure safety, Levinovitz mentions how many mothers felt that this transformed a miracle into a disease and treated the miracle bearers as ill patients. The experience reduced pregnancy to a medical condition, described only in terms of risk and reduced the value of the experience into purely scientific metrics. In this respect, it’s easy to see why many mothers opt for natural births, even with the associated risks.</p>
                <br></br>
            <h5 className="blog-subheadings">Natural at what cost?</h5>
            <p className="blog-p">
                ...
                <br></br>
                This process of artificial insemination of vanilla is by hand-pollinating every individual flower, an endeavour so expensive that most vanilla is derived from petrochemicals. The idea that anything I put in my mouth is comes from petrochemicals is sickening, on the basis that it isn’t natural. However, after little reflection I realised that the alternative (artificial insemination) isn’t much of a ‘natural’ alternative and as Levinovitz points out, the history of food seems to be built on its unnatural manipulation e.g., heating, cooling, mixing etc. I tried to find out exactly where I draw this arbitrary line and had no success.
                <br></br>
                Producing vanilla from petrochemicals not only democratises it, but also limits the number of children on plantations labouring to make ‘natural’ vanilla so I can feel better about what I eat. Then I guess where I would draw my arbitrary line is at the point where my pursuit for what is natural causes harm to others and the environment.</p>
                <br></br>  
        <h5 className="blog-subheadings">A privilege</h5>
            <p className="blog-p">
            Many around the world would leap at the opportunity to have access to cheap foods, even if its origin wasn’t ‘natural’ and many women around the global would give anything to have access to ‘unnatural’ neo-natal and maternal care. Levinovitz shares a story about when he spent time with the people of Huacaria, a native community in the Amazon, who were actively choosing to integrate fewer natural practices. An elderly Matsigenka women shared her gratitude for running water and another elderly man looked at Levinovitz with confusion when he was asked whether he was happy having electricity, responding yes as they could now see at night."
            <br></br>
            The modern dilemma of whether nature should be transcended seems to be a luxury problem that only those who live in comfort have to worry about. Tackling this requires gratitude for the unnatural advances that has provided us with the opportunity to have these discussions, and serious reflections on our personal relationship with nature."
            <br></br>
            Anyway, it’s a cool book, highly recommend.</p>
        </div>
    )
}
